...
/// An entry in a menu created by a [CustomMacosPulldownButton]. It can be either a
...
/// A divider (horizontal line) in a menu created by a [CustomMacosPulldownButton].
...
/// An item in a menu created by a [CustomMacosPulldownButton], typically a [Text]
/// widget.
...
class CustomMacosPulldownButton extends StatefulWidget {
  ...
  const CustomMacosPulldownButton({
    super.key,
    required this.items,
    required this.icon,
    this.onTap,
  ...
  @override
  State<CustomMacosPulldownButton> createState() => _CustomMacosPulldownButtonState();
}

class _CustomMacosPulldownButtonState extends State<CustomMacosPulldownButton> with WidgetsBindingObserver {
  ...
  @override
  void didUpdateWidget(CustomMacosPulldownButton oldWidget) {
  ...
  Widget build(BuildContext context) {
    ...
    final buttonStyles = _getButtonStyles(_pullDownButtonState, _enabled, context);

    Widget result = Container(
      decoration: _showHighlight
          ? const BoxDecoration(color: MacosColors.findHighlightColor, borderRadius: borderRadius)
          : BoxDecoration(
              boxShadow: [
                BoxShadow(
      ...
      height: 28,
      child: MacosIcon(widget.icon, color: buttonStyles.textColor, size: 14),
    );
